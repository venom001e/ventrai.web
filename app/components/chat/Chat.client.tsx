...
export const ChatImpl = memo(
  ({ description, initialMessages, storeMessageHistory, importChat, exportChat }: ChatProps) => {
    ...
    const append = async (message: Message, options?: any) => {
      ...
      try {
        console.log('📡 Making API call to /api/chat with messages:', newMessages);
    ...
    const reload = (options?: any) => {
      ...
      if (lastUserMessage) {
        console.log('🔄 Re-appending last user message:', lastUserMessage);
        append(lastUserMessage);
      } else {
        console.log('⚠️ No user message found to reload');
      }
    };
    ...
    const sendMessage = async (_event: React.UIEvent, messageInput?: string) => {
      console.log('📨 sendMessage called with input:', messageInput || input);
      ...
      if (!chatStarted) {
        console.log('🚀 First message - starting chat');
        setFakeLoading(true);
