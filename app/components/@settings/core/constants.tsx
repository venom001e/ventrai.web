...
import { User, Settings, Bell, Star, Database, Github, Wrench, List } from 'lucide-react';
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'github', visible: true, window: 'user' as const, order: 2 },
  { id: 'gitlab', visible: true, window: 'user' as const, order: 3 },
